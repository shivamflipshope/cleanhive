!(function () {
      ...
      return (
        ...
        new Promise((r, n) => {
          ...
          (i.type = "text/css"),
            ...
            (i.textContent = `\n\t\t\t\t@font-face {\n\t\t\t\t\tfont-family: ${_tpt.R[e].fontfamily};\n\t\t\t\t\tsrc: url("product/t-shirt/") format("woff2");\n\t\t\t\t}\n\t\t\t`),
            (i.onload = () => {
              (_tpt.R[e].status = 2), r();
            }),
            (i.onerror = () => {
  ...
  (_tpt.tEvtSimple = (t) =>
    ...
    (_tpt.divSize = (t) => {
      if ("#" == ("" + t)[0]) {
        let e = t.split("#")[1].split("index.html");
    ...
    (_tpt.gradient = {
      ...
      getSSGColors: (t, e, r) => {
        ...
        if (
          ...
          (p = t.substring(0, d)),
            -1 === e.indexOf("gradient(") && (c = t.substring(0, d));
        }
        if (-1 !== e.indexOf("gradient(")) {
          ...
          (c = e.substring(0, d)),
            -1 === t.indexOf("gradient(") && (p = e.substring(0, d));
        }
        return (
          "fading" === r
            ? (u.stops.length,
      ...
      insertPoints: (t, e, r, n, i) => {
        ...
        var a = t.p,
          u = e.p;
        if (!(a > u)) {
          for (var l, p, c, h = [], d = 0; d < i; d++)
            (p = parseFloat(n(d, 0, 1, i).toFixed(2)) * (u - a) + a) > a &&
              p < u &&
              (h[h.length] = p);
          var f,
            g,
          ...
          _tpt.ongoingTests[o] ||
            (_tpt.ongoingTests[o] = new Promise((i, s) => {
              ...
              if (
                ...
                h !== l.offsetWidth || d !== l.offsetHeight)
              )
                return (
                  (_tpt.R.fonts ??= {}), (_tpt.R.fonts[t] = 1), c(), void i()
                );
              (o = setInterval(() => {
                (l.offsetWidth === h && l.offsetHeight === d) ||
      ...
      if (!window.SR7?.E?.ignoreGoogleFont && null != _tpt.R.fonts) {
        ...
        _tpt.R.fonts.required)) {
          ...
          if (
            ...
            t.includes("georgia") ||
            t.includes("tahoma") ||
            t.includes("trebuchet+ms") ||
            t.includes("verdana") ||
            t.includes("courier") ||
            t.includes("courier+new") ||
            t.includes("impact") ||
            t.includes("comic+sans+ms")
          )
            continue;
          let l = i.replaceAll("'", ""),
            p =
  ...
  (() => {
     ...
     */ var r,
      ...
      _e = function (t, e, r) {
        var n,
          ...
          c,
          h,
          d = t ? (M(t) ? [t >> 16, (t >> 8) & de, t & de] : 0) : fe.black;
        if (!d) {
      ...
      Re(
        ...
        (_ = function (t) {
          return t < g
            ...
            ? d * Math.pow(t - 1.5 / f, 2) + 0.75
            : t < 0.9090909090909092
            ? d * (t -= 2.25 / f) * t + 0.9375
            : d * Math.pow(t - 2.625 / f, 2) + 0.984375;
        })
      ),
      Re("Expo", function (t) {
        ...
        (o.render = function (t, e, r) {
          ...
          if (
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  (m = w ? 0 : x % v ? v : x),
                  (this._lock = 1),
                  (this.render(m || (_ ? 0 : dt(u * l)), e, !v)._lock = 0),
                  (this._tTime = x),
            ...
            if (
              ...
              return (this._start = d), kt(this), this.render(t, e, r);
    ...
    var Ie,
      ...
      Xe = function (t, e, r, n, i, s, o) {
        ...
        for (
          g.b = r,
            g.e = n,
            r += "",
            (d = ~(n += "").indexOf("random(")) && (n = oe(n)),
            s && (s((f = [r, n]), t, e), (r = f[0]), (n = f[1])),
            u = r.match(X) || [];
          (a = X.exec(n));
      ...
      je = function (t, e, r, n, i, s, o, a, u, l) {
        ...
        if (
          ...
          return isNaN(h * n) || "" === n
            ? (!c && !(e in t) && U(e, n),
              Xe.call(this, t, e, h, n, d, a || m.stringFilter, u))
            : ((p = new ur(
                this._pt,
                t,
                e,
      ...
      qe = function t(e, i, o) {
        ...
        if (
          ...
          if (
            ((x = (f = L[0] ? lt(L[0]).harness : 0) && w[f.prop]),
            (a = wt(w, tt)),
            B &&
          ...
          for (
            ...
            if (
              ((d = (c = L[u])._gsap || ut(L)[u]._gsap),
              (e._ptLookup[u] = _ = {}),
              rt[d.id] && et.length && _t(),
              (m = I === L ? u : I.indexOf(c)),
              f &&
                !1 !== (g = new f()).init(c, x || a, e, m, I) &&
                ((e._pt = p =
          ...
          if (
            ...
            for (p = 0; p < h; p++)
              ((c = wt(n, Ue)).stagger = 0),
                ...
                _ && xt(c, _),
                (f = A[p]),
                (c.duration = +Ve(v, t(u), p, f, A)),
                (c.delay = (+Ve(y, t(u), p, f, A) || 0) - u._delay),
                !b &&
                  1 === h &&
                  c.delay &&
                  ((u._delay = y = c.delay), (u._start += y), (c.delay = 0)),
                l.to(f, c, g ? g(p, f, A) : 0),
                (l._ease = Ce.none);
            ...
            if (L(C))
              ...
              for (d in ((c = {}), C))
                "ease" === d || "easeEach" === d || Ge(d, C[d], c, C.easeEach);
              for (d in c)
                for (
            ...
            if (
              ...
              if (((i = m), (c = this.timeline), this._repeat)) {
                ...
                if (
                  ...
                  m === f
                    ? ((o = this._repeat), (i = g))
                    : ((o = ~~(m / a)) && o === dt(m / a) && ((i = g), o--),
                      i > g && (i = g)),
                  (l = this._yoyo && 1 & o) && ((h = this._yEase), (i = g - i)),
                  (u = Ot(this._tTime, a)),
                  i === d && !r && this._initted && o === u)
                )
              ...
              if (
                ...
                i && !d && !e && !o && (le(this, "onStart"), this._tTime !== m))
              )
                return this;
              ...
              (c &&
                ...
                (m !== this._tDur && m) ||
                  ...
                  e ||
                    (_ && !d) ||
                    !(m || d || l) ||
                    (le(this, m === f ? "onComplete" : "onReverseComplete", !0),
                    this._prom &&
    ...
    var br,
      ...
      _n = function t(e, r, n, i) {
        ...
        if (
          ...
          return (
            (s = u ? e.getBBox()[h ? "width" : "height"] : e[f]),
            ht(m ? (l / s) * g : (l / 100) * s)
          );
        if (
        ...
        return (
          h && m && (((a = lt(o)).time = be.time), (a.width = o[f])),
      ...
      Tn = function (t, e, r, n, i, s) {
        ...
        r
          ...
          n || (!1 !== n && l.smooth)
            ? ((v = b - c),
              (y = w - h),
              (l.xOffset = d + (v * g + y * m) - v),
              (l.yOffset = f + (v * _ + y * D) - y))
          ...
          s &&
            (dn(s, l, "xOrigin", c, b),
            dn(s, l, "yOrigin", h, w),
            dn(s, l, "xOffset", d, l.xOffset),
            dn(s, l, "yOffset", f, l.yOffset)),
      ...
      Ln = function (t, e) {
        ...
        (h = parseFloat(h)),
          (d = parseFloat(d)),
          (f = parseFloat(f)) && ((d += f = parseFloat(f)), (h += f)),
          h || d
            ? ((h *= Or),
              (d *= Or),
              (r = Math.cos(h) * g),
            ...
            if (
              ...
              if (
                ...
                (s = (getComputedStyle(t).getPropertyValue(c) + "").trim()),
                  (o += ""),
                  (ve.lastIndex = 0),
                  ve.test(s) || ((h = $t(s)), (d = $t(o))),
                  d ? h !== d && (s = _n(t, c, s, d) + d) : h && (o += h),
                ...
                if (
                  ...
                  if (
                    ...
                    (this._pt = new ur(
                      ...
                      "scaleY",
                      D.scaleY,
                      (f ? ft(D.scaleY, f + a) : a) - D.scaleY || 0,
                      Ir
                    )),
                      (this._pt.u = 0),
                      E.push("scaleY", c),
                      ...
                      x.push(Zr, 0, S[Zr]),
                        ...
                        D.svg
                          ...
                          : ((d = parseFloat(o.split(" ")[2]) || 0) !==
                              D.zOrigin && dn(this, D, "zOrigin", D.zOrigin, d),
                            dn(this, S, c, Mn(s), Mn(o)));
                      continue;
                    }
                    if ("svgOrigin" === c) {
                      Tn(t, o, 1, v, 0, this);
                ...
                if (
                  ...
                  a || (a = 0),
                    (h = (s + "").substr((u + "").length)) !==
                      (d = $t(o) || (c in m.units ? m.units[c] : h)) &&
                      (u = _n(t, c, s, d)),
                    (this._pt = new ur(
                      this._pt,
                      g ? D : S,
            ...
            ((h = (p = c[a]).parentNode === t) || N || (L && !B)) &&
              ...
              k &&
                (((p._isSplit && h) ||
                  ...
                  (d.push(p), (p._x -= y), li(p, t, R) && (p._wordEnd = !0)),
                "BR" === p.nodeName &&
          ...
          for (f = " " === R && (!N || (!B && !L)), a = 0; a < k.length; a++) {
            for (
              ...
              "BR" !== d[u].nodeName &&
                ((p = d[u]),
                _.appendChild(p),
                f && p._wordEnd && _.appendChild(Un.createTextNode(" ")),
                N &&
                  (0 === u &&
                    ((_.style.top = p._y + "px"),
                    (_.style.left = y + D + "px")),
    ...
    function $i(t, e, r, n) {
      ...
      return (
        ...
        (o = d.totalLength * e),
        (a = (l = d.lookup.length
          ? d.lookup[e < 1 ? ~~(o / d.minLength) : d.lookup.length - 1] || 0
          : Ni(i, o, e))
          ? i[l - 1]
          : 0),
        (u = i[l]) < o && ((a = u), (u = i[++l])),
        ...
        (f.x = ki(
          (p * p * (d[l + 6] - c) +
            3 * h * (p * (d[l + 4] - c) + h * (d[l + 2] - c))) *
            p +
            c
        )),
        (f.y = ki(
          (p * p * (d[l + 7] - (c = d[l + 1])) +
            3 * h * (p * (d[l + 5] - c) + h * (d[l + 3] - c))) *
            p +
            c
        )),
        r &&
          (f.angle = d.totalLength
            ? qi(d, l, p >= 1 ? 1 - 1e-9 : p || 1e-9)
            : d.angle || 0),
        f
      );
    }
            ...
            (g =
              ...
              ((d = D - (D - n) * (a ? l / a : 0)) +
                ((((f = D + (y - D) * (u ? l / u : 0)) - d) *
                  ...
                  4 || 0))),
            (m === r && D === n) ||
              x.push(ki(p + h), ki(d + g), ki(m), ki(D), ki(c + h), ki(f + g)));
      return (
        m !== v || D !== y || x.length < 4
              ...
              (u = d[s]),
                ...
                u.x <= 1
                  ? ((l.cx = u.x - l.x),
                    ...
                    _ &&
                      s > 1 &&
                      Math.abs(l.cy / l.cx - d[s - 2].cy / d[s - 2].cx) > 2 &&
                      (_ = 0),
                    l.cx < h &&
                      (l.cx
                        ? (h = l.cx)
    ...
    var cs,
      ...
      Ps = function () {
        vs() &&
          ...
          (fs = -1 !== ((ds.navigator || {}).userAgent || "").indexOf("Edge")));
      },
      ks = {
        version: "3.12.5",
        name: "drawSVG",
        ...
        init: function (t, e, r, n, i) {
          ...
          return (
            ...
            fs &&
              (a = ds.getComputedStyle(t)).strokeLinecap !== a.strokeLinejoin &&
    ...
    var qs,
      ...
      Zs = function (t, e) {
        ...
        if (
          ...
          (l = [0, 0, (a = _(d)) / 4, 0, a / 2, (u = f ? -g(d) : g(d)), a, u]),
          "random" === e.type)
        ) {
          for (
      ...
      zo = {
        ...
        init: function (t, e, r) {
          ...
          if (
            ...
            for (i in g)
              !d && ~Eo.indexOf(i) ? (d = i) : !f && ~To.indexOf(i) && (f = i);
            for (i in (d && f
              ? a.push(
                  Oo(
                    this,
    ...
    var jo,
      ...
      ru = function (t, e) {
        ...
        if (t === Yo)
          ...
          (r = i = 0),
            g
              ? ((h = (c = t.getBBox()).width), (d = c.height))
              : (t.viewBox &&
                  (c = t.viewBox.baseVal) &&
                  ((r = c.x || 0),
                  (i = c.y || 0),
            ...
            ut = function t(r) {
              if (H.autoScroll && H.isDragging && (Q || x)) {
                ...
                for (
                  ...
                  (n = (i = Ha(d.parentNode)) ? Ra : d.parentNode),
                    (s = i
                      ? {
                          bottom: Math.max(
                            Go.clientHeight,
              ...
              (c = !1),
                o
                  ...
                  : r.bounds &&
                    ...
                    X
                      ? ((H.minX = g = t.left),
                        (H.maxX = f = t.left + t.width),
                        (H.minY = m = H.maxY = _ = 0))
                      : fa(r.bounds.maxX) && fa(r.bounds.maxY)
                      ? ((n = tu(e, e.parentNode)),
                        (H.minX = g =
                          Math.round(st(j, "px") + t.left - n.left)),
                        (H.minY = m = Math.round(st(Y, "px") + t.top - n.top)),
                        (H.maxX = f = Math.round(g + (t.width - n.width))),
                      ...
                      : ((t = r.bounds),
                        ...
                        (H.maxX = f = t.maxX),
                        (H.maxY = _ = t.maxY)),
                    g > f && ((H.minX = f), (H.maxX = f = g), (g = H.minX)),
                    m > _ && ((H.minY = _), (H.maxY = _ = m), (m = H.minY)),
                    X && ((H.minRotation = g), (H.maxRotation = f)),
                    (c = !0)),
                r.liveSnap &&
                  ((i = !0 === r.liveSnap ? r.snap || {} : r.liveSnap),
                  (s = va(i) || ha(i)),
                  X
                    ? ((w = pt(s ? i : i.rotation, g, f, 1)), (C = null))
                    : i.points
                    ? (F = (function (t, e, r, n, i, s, o) {
                      ...
                      })(s ? i : i.points, g, f, m, _, i.radius, o ? -1 : 1))
                    : (q &&
                        (w = pt(
            ...
            ft = function (t, n) {
              ...
              t && ra
                ? (!0 === t &&
                    ...
                    X
                      ? (t.rotation = nu(H, s ? i : i.rotation, f, g, 1, n))
                      : (q &&
                          (t[j] = nu(
                            H,
                  ...
                  d && c
                    ...
                    : (ft(r.inertia || r.throwProps),
                      ...
                      !1 === c.cancelable
                        ...
                        : ((B = !0), za(c)),
                      Ka(H, "release", "onRelease")),
                  mt() && f.duration(H.tween.duration()),
                ...
                if (
                  ...
                  for (
                    ...
                    (u = (l = Ha(a.parentNode)) ? Ra : a.parentNode),
                      ...
                      (a = u);
                H.isThrowing &&
                  (o || H.endX > f || H.endX < g || H.endY > _ || H.endY < m) &&
                  ft(r.inertia || r.throwProps, o);
              }
              return H;
            }),
    ...
    var pu,
      ...
      Eu = (function () {
        ...
        return (
          ...
          (e.add = function (t, e) {
            t in this._props ||
              (fu || (gu.add(bu), (_u = gu.time)),
              (fu = this._props[t] = new Fu(this.target, t, e, fu)));
          }),
          (e.remove = function (t) {
            var e,
              r,
            ...
            n &&
              ...
              (r = n._next),
              e && (e._next = r),
              r ? (r._prev = e) : fu === n && (gu.remove(bu), (fu = 0)),
    ...
    var Tu,
      ...
      ol = {
        ...
        init: function (t, e, r, n, i) {
                    ...
                    nl[o] ||
                      ...
                      Vu(a) &&
                        ...
                        "max" in a && c > +a.max + 1e-10
                          ? ((f = a.unitFactor || Ou.unitFactors[o] || 1),
                            (h =
                              (p > a.max && a.min !== a.max) ||
                              (l * f > -15 && l * f < 45)
                                ? n + 0.1 * (r - n)
          ...
          for (o in ((e = Iu), (Iu = 0), (f = il(t, e, _, y)), e))
            nl[o] ||
              ((a = e[o]),
              Hu(a) && (a = a(n, t, i)),
              Gu(a)
